...
public interface SlaveDBDao {
     ...
     */
    List<Map<String, Object>> queryByCrtDt(String tableName, String crtName, String startDate, String endDate, JdbcTemplate slaveTemplate);
     ...
     * @return 结果集
     */
    List<Map<String, Object>> queryById(String tableName, int page, int pageSize, JdbcTemplate slaveTemplate);
}
